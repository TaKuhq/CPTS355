...
##############################
    def test_counttomark1(self):
        ...
        pop()
        counttomark()         
        self.assertTrue(opPop()== 2 and opPop()==20 and opPop()==10 and opPop()=='-mark-' and opPop()==3 and opPop()==2 and opPop()==1)    
##################################################
    def test_cleartomark1(self):
...
##################################
    def test_getinterval1(self):
        opPush([1,2,3,4,5,6,7,8,9])
        opPush(2)
        opPush(5)
        getinterval()
        self.assertEqual(opPop(),[3, 4, 5, 6, 7])         
        self.assertTrue(len(opstack)==0)        
##############################################
...
##################################################
    def test_put4(self):
        ...
        opPush(0)
        put()
        self.assertEqual(opPop(),[1, 2, 3, 4, 5, 0, 7, 8, 9])
        self.assertTrue(len(opstack)==0)
###############################################################
...
#########################################
    def test_putinterval1(self):
        opPush([3,5,1,2,6,8,2])
        dup() # we duplicate the array reference
        opPush(4)
        opPush([3,5,5])
        putinterval()
        self.assertEqual(opPop(),[3, 5, 1, 2, 3, 5, 5])
        self.assertTrue(len(opstack)==0)
#########################################
...
#######################################
    def test_beginEnd2(self):
        ...
        self.assertEqual(lookup('hello'),1)
#####################################
